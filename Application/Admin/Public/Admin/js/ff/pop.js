...
var Window = function(config){
    ...
    var nr = "<div class='zhuti' id='"+idzt[x]+"' bs='"+x+"' style='width:"+this.config.width+"px; height:"+this.config.height+"px; background-color:white; left:"+w+"px; top:"+h+"px;position: fixed;z-index: 3;'></div>";
    $("body").append(nr);

    //加载弹窗标题
    var content ="<div id='title"+x+"' class='title' bs='"+x+"'>"+this.config.title+"<div id='close"+x+"' class='close' bs='"+x+"'>×</div></div>";
    //加载弹窗内容
    var nrh = this.config.height - 100;
