...
class MenuController extends AdminController {
    ...
    public function index(){
        ...
        //分页
        $total = M("Menu")->where($map)->count();
        $page = getNewPage($total,self::$limit);
        $p = $page->show();
        $this->assign('_page', $p);
        $list       =   M("Menu")->where($map)->field(true)->order('sort asc,id asc')->limit($page->firstRow,$page->listRows)->select();
